...
def run_inference(args):
    ...
    # # Shooting001_x264.mp4, frames:80, pool stride:3
    # question = "Describe the main subjects in the video, detailing their appearance and actions. Specifically, focus on any instances involving firearms, physical assault, \
    # or criminal activities. Additionally, identify and explain any significant, abnormal, or criminal situations observed in the video. \
    # Highlight any activities or behaviors that may be indicative of such situations, and provide detailed descriptions to clarify these observations."

    ## Shoplifting001_x264.mp4, frames:80, pool stride:3
    # question = "Pay attention to any individuals who may be hiding items under their clothing or placing items into bags, as these actions may indicate theft. Identify and explain any significant, abnormal, or criminal situations observed in the video."
    
    # # Stealing006_x264.mp4, frames: 240, pool stride: 3
    # question = "Pay attention to individuals who are sitting or standing around to the vehicle, as these actions may indicate vehicle theft. Identify and explain any significant, abnormal, or criminal situations observed in the video."

    # Vandalism004_x264.mp4, frames:40, pool stride:2
    question = "Pay attention to any vehicles that may be engaging in vandalism, such as damaging or defacing property. Identify and explain any significant, abnormal, or criminal situations observed in the video."
